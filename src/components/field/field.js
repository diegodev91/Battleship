...
export default function Field() {
  let battlefield = [
    [
      ...
      { coordinates: { x: 1, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 2, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 3, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 4, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 5, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 6, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 7, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 8, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 9, y: 0 }, type: "columnHeader" },
      { coordinates: { x: 10, y: 0 }, type: "columnHeader" },
    ],
    [
      { coordinates: { x: 0, y: 1 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 2 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 3 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 4 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 5 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 6 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 7 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 8 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 9 }, type: "rowHeader" },
    ...
    [
      { coordinates: { x: 0, y: 10 }, type: "rowHeader" },
